...
class kabupaten extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kabupaten.index')->with('alert_massage', 'Berhasil menambah data!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('kabupaten.index')->with('alert_massage', 'Berhasil mengubah data!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('kabupaten.index')->with('alert_massage', 'Berhasil menghapus data!');
    }
}
